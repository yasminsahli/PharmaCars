    ...
    <div id="table">
      ...
      <table class="table table-bordered table-responsive-md table-striped text-center">
        ...
        <tbody>
            ...
            <tr>
              <td class="pt-3-half" contenteditable="true"> {{$Visiteur->VISITId}} </td>
              ...
              <td class="pt-3-half" contenteditable="false">
                <a type="button" class="btn btn-outline-danger2" href="{{route('goModifVisit')}}">
                    Modifier
                </a>
              </td>
              <td class="pt-3-half" contenteditable="false"> 
                <a type="button" class="btn btn-outline-danger2" href="{{route('goSupprVisit')}}">
                    Supprimer
                </a>
              </td>
            </tr>  
