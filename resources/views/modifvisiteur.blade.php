             ...
             <form class="needs-validation" novalidate>
                 <div class="form-row" style="padding : 0 20%">
                     ...
                     <div class="mb-3">
                         ...
                         <input type="text" class="form-control" id="adresse" placeholder="Dumontet" required>
                         <div class="valid-feedback">Ok !</div>
                         <div class="invalid-feedback">Valeur incorrecte</div>
                     </div>
                     <div class="mb-3">
                         <label for="pseudo">Prénom</label>
                         <input type="text" class="form-control" id="cp" placeholder="Lola" required>
                         <div class="valid-feedback">Ok !</div>
                         <div class="invalid-feedback">Valeur incorrecte</div>
                     </div>
                 </div>
                 <div class="form-row" style = "padding : 0 20%">
                     <div class="mb-3">
                         <label for="ville">Âge</label>
                         <input type="text" class="form-control" id="ville" placeholder="23" required>
                         <div class="valid-feedback">Ok !</div>
                         <div class="invalid-feedback">Valeur incorrecte</div>
                     </div>
                     <div class="mb-3">
                         <label for="cp">Poste occupé</label>
                         <input type="number" class="form-control" id="codetypec" placeholder="Stagiaire" required>
                         <div class="valid-feedback">Ok !</div>
                         <div class="invalid-feedback">Valeur incorrecte</div>
                     </div>
                 </div>
